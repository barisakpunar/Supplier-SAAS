...
public partial class DealerTransactionBuilder : NopEntityBuilder<DealerTransaction>
{
    ...
    public override void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            .WithColumn(nameof(DealerTransaction.SourceTypeId)).AsInt32().NotNullable().WithDefaultValue((int)DealerTransactionSourceType.None).Indexed()
            .WithColumn(nameof(DealerTransaction.SourceId)).AsInt32().Nullable().Indexed()
            .WithColumn(nameof(DealerTransaction.ReferenceNo)).AsString(400).Nullable()
