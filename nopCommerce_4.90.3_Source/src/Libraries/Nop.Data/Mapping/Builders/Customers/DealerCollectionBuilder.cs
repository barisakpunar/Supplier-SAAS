...
public partial class DealerCollectionBuilder : NopEntityBuilder<DealerCollection>
{
    ...
    public override void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            // This link is added in a later schema migration to avoid a cyclic FK during fresh installations.
            .WithColumn(nameof(DealerCollection.DealerFinancialInstrumentId)).AsInt32().Nullable()
            ...
            .WithColumn(nameof(DealerCollection.DocumentNo)).AsString(400).Nullable()
            .WithColumn(nameof(DealerCollection.IssueDateUtc)).AsDateTime2().Nullable().Indexed()
            .WithColumn(nameof(DealerCollection.DueDateUtc)).AsDateTime2().Nullable().Indexed()
